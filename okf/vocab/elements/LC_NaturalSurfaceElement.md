...
kind: vocab_element
title: LC_NaturalSurfaceElement
lchs_type: LC_NaturalSurfaceElementType
lccs3_types:
- LC_NaturalSurface
properties:
- elementPresenceType
...
LChS reference name `LC_NaturalSurfaceElement` (schema type `LC_NaturalSurfaceElementType`). LCCS3 `xsi:type`: `LC_NaturalSurface`.
