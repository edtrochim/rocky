...
kind: vocab_element
title: LC_RocksSurfaceElement
lchs_type: LC_RocksSurfaceElementType
lccs3_types:
- LC_RocksSurface
properties:
- elementPresenceType
...
Rocks Surface Element

LChS reference name `LC_RocksSurfaceElement` (schema type `LC_RocksSurfaceElementType`). LCCS3 `xsi:type`: `LC_RocksSurface`.
