...
kind: vocab_element
title: LC_OrganicDeposits
lchs_type: LC_OrganicDepositsType
lccs3_types:
- LC_OrganicDeposits
properties:
- elementPresenceType
...
- rel: allows
  id: enum:OrganicDepositTypesEnum
  path: ../enums/OrganicDepositTypesEnum.md
- rel: allows
...
LChS reference name `LC_OrganicDeposits` (schema type `LC_OrganicDepositsType`). LCCS3 `xsi:type`: `LC_OrganicDeposits`.
...
| `organicDepositType` | OrganicDepositTypesEnum | `ombrothrophicPeat`, `minerothrophicPeat` |  | Organic Deposit Type |
