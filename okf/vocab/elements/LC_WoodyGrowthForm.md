...
kind: vocab_element
title: LC_WoodyGrowthForm
lchs_type: LC_WoodyGrowthFormType
lccs3_types:
- LC_WoodyGrowthForms
properties:
- elementPresenceType
...
Growth Form Element of Woody Subtype

LChS reference name `LC_WoodyGrowthForm` (schema type `LC_WoodyGrowthFormType`). LCCS3 `xsi:type`: `LC_WoodyGrowthForms`.
