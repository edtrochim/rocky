...
- rel: allows
  id: enum:ExtractionTypesEnum
  path: ../enums/ExtractionTypesEnum.md
- rel: allows
...
LChS reference name `LC_Extraction` (schema type `LC_ExtractionType`). LCCS3 `xsi:type`: `LC_Extraction`.
...
| `extractionType` | ExtractionTypesEnum | `surface`, `subsurface` |  | Extraction Type |
