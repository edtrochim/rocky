...
- rel: allows
  id: enum:SnowTypesEnum
  path: ../enums/SnowTypesEnum.md
- rel: allows
...
LChS reference name `LC_Snow` (schema type `LC_SnowType`). LCCS3 `xsi:type`: `LC_Snow`.
...
| `snowType` | SnowTypesEnum | `crud`, `crust`, `powder`, `sludge` |  | Snow Type |
