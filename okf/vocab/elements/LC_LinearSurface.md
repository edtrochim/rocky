...
kind: vocab_element
title: LC_LinearSurface
lchs_type: LC_LinearSurfaceType
lccs3_types:
- LC_LinearSurface
- LC_Road
- LC_Railway
- LC_CommunicationsAndOther
properties:
- elementPresenceType
- linearSurfaceType
...
LChS reference name `LC_LinearSurface` (schema type `LC_LinearSurfaceType`). LCCS3 `xsi:type`: `LC_LinearSurface`, `LC_Road`, `LC_Railway`, `LC_CommunicationsAndOther`.
...
| `linearSurfaceType` | xs:string |  |  | Linear Surface Type |
