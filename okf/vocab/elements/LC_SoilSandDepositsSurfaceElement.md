...
kind: vocab_element
title: LC_SoilSandDepositsSurfaceElement
lchs_type: LC_SoilSandDepositsSurfaceElementType
lccs3_types:
- LC_SoilSandDepositSurface
properties:
- elementPresenceType
- cover
- height
...
Soils & Sand Deposits Surface Element

LChS reference name `LC_SoilSandDepositsSurfaceElement` (schema type `LC_SoilSandDepositsSurfaceElementType`). LCCS3 `xsi:type`: `LC_SoilSandDepositSurface`.
