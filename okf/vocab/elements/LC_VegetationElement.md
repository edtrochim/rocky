...
kind: vocab_element
title: LC_VegetationElement
lchs_type: LC_VegetationElementType
lccs3_types:
- LC_Vegetation
properties:
- elementPresenceType
...
Generic Vegetation Element

LChS reference name `LC_VegetationElement` (schema type `LC_VegetationElementType`). LCCS3 `xsi:type`: `LC_Vegetation`.
