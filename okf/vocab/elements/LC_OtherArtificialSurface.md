...
kind: vocab_element
title: LC_OtherArtificialSurface
lchs_type: LC_OtherArtificialSurfaceType
lccs3_types:
...
Other Artificial Surface

LChS reference name `LC_OtherArtificialSurface` (schema type `LC_OtherArtificialSurfaceType`). LCCS3 `xsi:type`: `LC_OtherArtificialSurface`.
...
| `sealed` | BooleanEnum | `true`, `false` |  | Sealed |
