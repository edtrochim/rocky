...
kind: vocab_element
title: LC_NonBuiltUpSurface
lchs_type: LC_NonBuiltUpSurfaceType
lccs3_types:
...
Non-Built-Up Surface Element

LChS reference name `LC_NonBuiltUpSurface` (schema type `LC_NonBuiltUpSurfaceType`). LCCS3 `xsi:type`: `LC_NonBuiltUpSurface`, `LC_Deposit`.
