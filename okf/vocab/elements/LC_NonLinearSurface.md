...
kind: vocab_element
title: LC_NonLinearSurface
lchs_type: LC_NonLinearSurfaceType
lccs3_types:
- LC_NonLinearSurface
properties:
- elementPresenceType
...
LChS reference name `LC_NonLinearSurface` (schema type `LC_NonLinearSurfaceType`). LCCS3 `xsi:type`: `LC_NonLinearSurface`.
