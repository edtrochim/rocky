...
kind: vocab_element
title: LC_LichenAndMoss
lchs_type: LC_LichenAndMossType
lccs3_types:
- LC_LichenAndMosses
properties:
- elementPresenceType
...
Growth Form Element of Lichen & Moss Subtype

LChS reference name `LC_LichenAndMoss` (schema type `LC_LichenAndMossType`). LCCS3 `xsi:type`: `LC_LichenAndMosses`.
