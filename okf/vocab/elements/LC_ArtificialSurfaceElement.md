...
kind: vocab_element
title: LC_ArtificialSurfaceElement
lchs_type: LC_ArtificialSurfaceElementType
lccs3_types:
- LC_ArtificialSurface
properties:
- elementPresenceType
- cover
- height
...
Artificial Surface Element

LChS reference name `LC_ArtificialSurfaceElement` (schema type `LC_ArtificialSurfaceElementType`). LCCS3 `xsi:type`: `LC_ArtificialSurface`.
