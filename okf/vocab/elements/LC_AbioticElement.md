...
kind: vocab_element
title: LC_AbioticElement
lchs_type: LC_AbioticElementType
lccs3_types:
- LC_AbioticSurface
properties:
- elementPresenceType
...
Generic Abiotic Element

LChS reference name `LC_AbioticElement` (schema type `LC_AbioticElementType`). LCCS3 `xsi:type`: `LC_AbioticSurface`.
